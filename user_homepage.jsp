...
<input id="userNameFromLogin" value="${userName}">
...
<%--                    <li class="align-content-center nav-item">--%>
<%--                        <a href="#int" class="nav-link text-white"><a1> </a1></a>--%>
<%--                    </li>--%>
                    <li>
        ...
        <div class="container text-center p-3 text-white">
            ...
            <div class="row">
                ...
                <div class="col-lg-3"> <img src="${APP_PATH}/static/people-image/shuai.png" class="rounded-circle" width="140">
                    <h2>Shuai Wang</h2>
                    <p>Master @ Carnegie Mellon University</p>
                </div>
        ...
        <div class="container marketing p-3 text-white">
            ...
            <div class="row">
                <div class="col-lg-6"> <img src="${APP_PATH}/static/people-image/ding.jpg" class="rounded-circle mx-auto d-block" width="140">
                    ...
                    <p class="text-center">Assistant Professor @ Carnegie Mellon University</p>
                </div>
                <!-- /.col-lg-4 -->
                <div class="col-lg-6"> <img src="${APP_PATH}/static/people-image/hesheng.png" class="rounded-circle d-block mx-auto" width="140">
                    <h2 class="text-center">Heshang Wang</h2>
                    <p class="text-cen text-center">Professor @&nbsp; Shanghai Jiao Tong University</p>
                </div>
                <!-- /.col-lg-4 -->
                <!-- /.col-lg-4 -->
            </div>
...
<script type="text/javascript">
    function fillUserName(){
        var curUserName = $("#userNameFromLogin").val();

        console.log(curUserName);

    }
    window.onload = fillUserName;
</script>
